    ...
    return (
        <>
            <m.div animate={{ opacity: 1, y: "0%" }} initial={{ opacity: 1, y: "150%" }} transition={{ duration: 1 }} exit={{ opacity: 0 }} className="h-full w-full flex flex-col absolute bg-one text-text">
                ...
                <div className="h-[60%] lg:h-[60%] lg:-mt-14 lg:w-4/5 mx-auto no-scrollbar flex flex-col items-center overflow-scroll overscroll-none m-5" >
...
function ProjectCard({ props }) {
    return (
        <>
            <div className='w-4/5 text-lg text-left h-1/2 flex flex-col my-auto sm:px-20'>
